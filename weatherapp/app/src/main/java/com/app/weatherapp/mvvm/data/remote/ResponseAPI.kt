...
data class Model (
        ...
        @SerializedName("alerts") val alerts : List<Alerts>?=null
)
@Parcelize
@Entity(tableName = "favourite_table",indices = [Index(value=["lat","lon"],unique=true)])
data class Favourite (
        ...
        @SerializedName("hourly") val hourly : List<Hourly>,
        @SerializedName("daily") val daily : List<Daily>,
        val cityName :String=Settings.mapCity,
        val cityloction:String=Settings.cityPlace
):Parcelable
